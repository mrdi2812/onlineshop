...
namespace OnlineShop.WebAPI.Api
{
    ...
    public class ApplicationGroupController : ApiControllerBase
    {
        ...
        public HttpResponseMessage Details(HttpRequestMessage request,int id)
        {
            ...
            var appGroupVm = Mapper.Map<ApplicationGroup, ApplicationGroupViewModel>(appGroup);
            if (appGroupVm == null)
            {
                return request.CreateErrorResponse(HttpStatusCode.NoContent, "Không có nhóm nào");
            }
        ...
        public HttpResponseMessage Create(HttpRequestMessage request,ApplicationGroupViewModel appGroupVm)
        {
            if (ModelState.IsValid)
            {
                var newAppGroup = new ApplicationGroup();
                newAppGroup.Name = appGroupVm.Name;
                try
                {
